...
* Originating service cluster set via the :ref:`Bootstrap node <envoy_api_field_config.bootstrap.v2.Bootstrap.node>` message's :ref:`cluster <envoy_api_field_core.Node.cluster>` field. option..
* Start time and duration of the request.
* Originating host set via the :ref:`Bootstrap node <envoy_api_field_config.bootstrap.v2.Bootstrap.node>` message's :ref:`cluster <envoy_api_field_core.Node.id>` field. option..
